...
var ThemeProvider = function (_a) {
    ...
    var availableThemes = useState(themes)[0];
    ...
    useEffect(function () {
        ...
        var classesToRemove = Array.from(body.classList).filter(function (className) {
            return className.startsWith('bg-') && className.includes('theme');
        });
...
export { ThemeContext, ThemeProvider, allThemes, applyThemeToDOM, arcticDark, arcticLight, darkThemes, allThemes as default, forestLight, generateCSSVariables, generateMultipleThemesCSS, generateTailwindConfig, getContrastRatio, hexToRgb, isAccessible, lightThemes, oceanicLight, sakuraLight, sunsetLight, useIsDarkMode, useTheme, useThemeColors, useToggleDarkMode };
